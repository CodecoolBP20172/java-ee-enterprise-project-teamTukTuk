...
INSERT INTO users (age, email, firstname, lastname, password, gender, partnergender, inConversation, optpartnerperstype, personalitytype) VALUES (31, 'Clare@email.com', 'Clare', 'Fraeser', 'password', 'female', 'male', FALSE , 'REFORMER', 'INVESTIGATOR');
INSERT INTO users (age, email, firstname, lastname, password, gender, partnergender, inConversation, optpartnerperstype, personalitytype) VALUES (22, 'Mike@email.com', 'Mike', 'Gregg', 'password', 'male', 'female', FALSE , 'LOYALIST', 'CHALLENGER');
INSERT INTO users (age, email, firstname, lastname, password, gender, partnergender, inConversation, optpartnerperstype, personalitytype) VALUES (26, 'layla@email.com', 'layla', 'Jackson', 'password', 'female', 'male', FALSE , 'LOYALIST', 'HELPER');
